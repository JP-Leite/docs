...
| permissions | Required | The permissions to be added to the users or groups. For example: `[ { "permission": "Read", "granted": false, "group": { "id": "1234567890", "name": "hr" } }, { "permission": "Read", "granted": false, "group": { "id": "9876543210", "name": "sales" } } ]` |
