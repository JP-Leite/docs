...
---
title: "CREATE_CONTENT"
source: "https://support.hyland.com/r/Current/Hyland-Automate-Modeler/qdh1704702085163"
...
| --- | --- | --- |
| contentType | Required | The content type name from the repository content types and the properties from that content type schemas to be set. For example:{
  "metadataType": "my-custom-type",
  "properties": {
    "my_prop": "value1"
  }
} |
