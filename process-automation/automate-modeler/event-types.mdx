...
---
title: "Event Types"
source: "https://support.hyland.com/r/Current/Hyland-Automate-Modeler/xxq1673531545001"
...
| ACTIVITY_CANCELLED | An activity has been canceled. |
...
| TIMER_CANCELLED | A timer has been canceled, for example if a task was completed before the timer expired. |
...
| PROCESS_CANCELLED | A process instance has been canceled. |
...
| TASK_CANCELLED | A task has been canceled. |
